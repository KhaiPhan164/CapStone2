...
<p className="text-gray-600 mb-8 sm:w-[600px] text-center">We offer expert-led workouts, personalized plans, and the flexibility to train wherever you are. Whether you're a beginner or advanced, our platform helps you stay consistent, motivated, and see real results—on your terms.</p>        <div className="flex flex-wrap justify-center gap-4">
