...
const Calendar = () => {
  ...
  const handleEventClick = (clickInfo) => {
    ...
    if (
      (planName === "Unknown Plan" || !planName) &&
  ...
  const renderEventContent = (eventInfo) => {
    ...
    const planName =
      ...
      eventInfo.event.extendedProps.planName ||
      "Workout";
    ...
    <div className="">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 gap-2">
        ...
        <button
          ...
          className="w-full sm:w-auto px-4 py-2 bg-primary-500 text-white rounded-md hover:bg-primary-600 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
        >
          Create New Schedule
        </button>
      </div>
