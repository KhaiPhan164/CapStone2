...
import { faEdit, faUser, faCog, faHistory, faDumbbell, faCalendarAlt } from "@fortawesome/free-solid-svg-icons";
    ...
    if (isEditingProfile) {
      try {
        ...
        const updateData = {
          ...
          specialization: editData.specialization?.trim() || null,
          hourlyRate: editData.hourlyRate?.trim() || null,
  ...
  const renderTabContent = () => {
    switch (activeTab) {
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="font-semibold text-text">
                  {isEditingProfile ? (
                    <input
                      type="text"
                      value={editData.experience || userData.experience || ''}
                      onChange={(e) => handleInputChange('experience', e.target.value)}
                      className="w-full border-b-2 border-gray-300 focus:border-orange-400 outline-none px-2 py-1"
                      placeholder="Nhập số năm kinh nghiệm"
                    />
                  ) : (
                    userData.experience || 'Chưa có'
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="font-semibold text-text">
                  {isEditingProfile ? (
                    <input
                      type="text"
                      value={editData.specialization || userData.specialization || ''}
                      onChange={(e) => handleInputChange('specialization', e.target.value)}
                      className="w-full border-b-2 border-gray-300 focus:border-orange-400 outline-none px-2 py-1"
                      placeholder="Nhập chuyên môn"
                    />
                  ) : (
                    userData.specialization || 'Chưa có'
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="font-semibold text-text">
                  {isEditingProfile ? (
                    <input
                      type="text"
                      value={editData.hourlyRate || userData.hourlyRate || ''}
                      onChange={(e) => handleInputChange('hourlyRate', e.target.value)}
                      className="w-full border-b-2 border-gray-300 focus:border-orange-400 outline-none px-2 py-1"
                      placeholder="Nhập giá theo giờ"
                    />
                  ) : (
                    userData.hourlyRate || 'Chưa có'
                  )}
                </div>
              </div>
              ...
              <div className="col-span-2">
                ...
                <div className="font-semibold text-text">
                  {isEditingProfile ? (
                    <textarea
                      value={editData.bio || userData.bio || ''}
            ...
            <div className="mt-4">
              <div className="grid grid-cols-7 gap-2">
                ...
                {Array.from({ length: 35 }).map((_, index) => (
                  <div key={index} className="aspect-square border rounded p-2 hover:bg-gray-50 cursor-pointer">
                    <div className="text-sm text-gray-500">{index + 1}</div>
                    <div className="text-xs text-primary-500 mt-1">8:00 - 10:00</div>
                  </div>
                ))}
              </div>
            </div>
      ...
      case 'clients':
        return (
          <div className="bg-white p-6 rounded-lg shadow-md">
            <SectionTitle title="Danh sách học viên" />
            <div className="mt-4">
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 border rounded">
                  <div className="flex items-center">
                    <img
                      src="https://storage.googleapis.com/a1aa/image/cD-sKP-sj6D5N0EfMvBgXVgHCnSaBHEl4rdOuhfaNkQ.jpg"
                      alt="Học viên"
                      className="w-12 h-12 rounded-full mr-4"
                    />
                    <div>
                      <h3 className="font-semibold">Nguyễn Văn A</h3>
                      <p className="text-sm text-gray-500">Buổi tập: 3/10</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 border rounded">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Buổi tập: 5/12</p>
                    </div>
                  </div>
                  <button className="text-primary-500 hover:text-primary-600">
                    Chi tiết
