  ...
  return (
    <div className='pt-10 px-4 md:px-20 lg:px-32 bg-gray-900 w-full overflow-hidden' id='Footer'>
        <div className='container mx-auto flex flex-col md:flex-row justify-between items-start'>
            <div className="md:w-[500px] w-[300px] mb-5 md:mb-0 mr-20">
                <img src="./icon/logo_trang.svg" alt="" className="w-20 h-10"/> 
                <p className='text-gray-400 mt-1 ư'>We’re redefining fitness with real results, expert support, and flexible training that fits your life. No fluff—just what works.</p>
            </div>
