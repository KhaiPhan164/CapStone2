  ...
  return (
    <div className='pt-10 px-4 md:px-20 lg:px-32 bg-gray-900 w-full overflow-hidden' id='Footer'>
        <div className='container mx-auto flex flex-col md:flex-row justify-between items-start'>
            <div>
                <p className='text-gray-400 mt-4'>Lorem ipsum is simply dummy text of the printing and typesetting industry</p>
            </div>
        ...
        <div className='w-full md:w-1/5 mb-8 md:mb-0'>
            ...
            <ul className='flex flex-col gap-2 text-gray-400'>
                ...
                <a href="#About" className='hover:text-white'>Classes</a>
                <a href="#Contact" className='hover:text-white'>Programs</a>
